...
async function main() {
  ...
  await prisma.appSettings.upsert({
    ...
    create: {
      ...
      planTextModel: "gpt-4o",
      copyTextProvider: "OPENAI",
      copyTextModel: "gpt-4o",
      insightsProvider: "OPENAI",
      insightsModel: "gpt-4o",
  ...
  await prisma.projectProfile.upsert({
    ...
    create: {
      projectId: 1,
      brandName: "ILARIA",
      audience: "Women who want to look and feel chic at any weight, figure, and age, through smart styling and comfortable, versatile pieces.",
      offers: "Comfort-first bras\nGentle shapewear\nLong-wear support pieces",
      goals: "Follower growth\nLead generation\nBrand recall",
      contentPillars: "Styling & looks\nStaying chic & self-care\nProduct features & craft\nEveryday wearability",
      currentPriorities: "Show how to style and mix the pieces\nHighlight product features and all-day wearability\nKeep an aspirational, age-agnostic, good-vibes tone",
